#if 0
#pragma _class(QtProcessorDetection)
#pragma sync_skip_header_check
#pragma sync_stop_processing
#endif

#ifndef UTILS_PROCESSORDETECTION_H_
#define UTILS_PROCESSORDETECTION_H_

/*
    This file uses preprocessor #defines to set various E_PROCESSOR_* #defines
    based on the following patterns:

    E_PROCESSOR_{FAMILY}
    E_PROCESSOR_{FAMILY}_{VARIANT}
    E_PROCESSOR_{FAMILY}_{REVISION}
    ...
    E_BYTE_ORDER appropriately for the target processor. For bi-endian
...
#  define E_BIG_ENDIAN __ORDER_BIG_ENDIAN__
#else
#  define E_BIG_ENDIAN 4321
#endif
#if defined(__ORDER_LITTLE_ENDIAN__)
#  define E_LITTLE_ENDIAN __ORDER_LITTLE_ENDIAN__
#else
...
#  define E_PROCESSOR_ALPHA
// E_BYTE_ORDER not defined, use endianness auto-detection
...
#    define E_PROCESSOR_ARM_64
#    define E_PROCESSOR_WORDSIZE 8
#  else
#    define E_PROCESSOR_ARM_32
#  endif
#  if defined(__ARM_ARCH) && __ARM_ARCH > 1
#    define E_PROCESSOR_ARM __ARM_ARCH
#  elif defined(__TARGET_ARCH_ARM) && __TARGET_ARCH_ARM > 1
#    define E_PROCESSOR_ARM __TARGET_ARCH_ARM
#  elif defined(_M_ARM) && _M_ARM > 1
#    define E_PROCESSOR_ARM _M_ARM
#  elif defined(__ARM64_ARCH_8__) \
      || defined(__aarch64__) \
      || defined(__ARMv8__) \
      || defined(__ARMv8_A__) \
      || defined(_M_ARM64)
#    define E_PROCESSOR_ARM 8
...
#    define E_PROCESSOR_ARM 6
#  elif defined(__ARM_ARCH_5TEJ__) \
        || defined(__ARM_ARCH_5TE__)
#    define E_PROCESSOR_ARM 5
#  else
#    define E_PROCESSOR_ARM 0
#  endif
#  if E_PROCESSOR_ARM >= 8
#    define E_PROCESSOR_ARM_V8
#  endif
#  if E_PROCESSOR_ARM >= 7
#    define E_PROCESSOR_ARM_V7
#  endif
#  if E_PROCESSOR_ARM >= 6
#    define E_PROCESSOR_ARM_V6
#  endif
#  if E_PROCESSOR_ARM >= 5
#    define E_PROCESSOR_ARM_V5
#  else
#    error "ARM architecture too old"
#  endif
#  if defined(__ARMEL__) || defined(_M_ARM64)
#    define E_BYTE_ORDER E_LITTLE_ENDIAN
#  elif defined(__ARMEB__)
#    define E_BYTE_ORDER E_BIG_ENDIAN
#  else
// E_BYTE_ORDER not defined, use endianness auto-detection
#endif
...
#  define E_PROCESSOR_X86_32
#  define E_BYTE_ORDER E_LITTLE_ENDIAN
#  define E_PROCESSOR_WORDSIZE   4

/*
 * We define E_PROCESSOR_X86 == 6 for anything above a equivalent or better
...
#  define E_PROCESSOR_LOONGARCH
#  if __loongarch_grlen == 64
#    define E_PROCESSOR_LOONGARCH_64
#  else
#    define E_PROCESSOR_LOONGARCH_32
#  endif
#  define E_BYTE_ORDER E_LITTLE_ENDIAN
...
#  define E_PROCESSOR_POWER
#  if defined(__ppc64__) || defined(__powerpc64__) || defined(__64BIT__)
#    define E_PROCESSOR_POWER_64
#    define E_PROCESSOR_WORDSIZE 8
#  else
#    define E_PROCESSOR_POWER_32
#  endif
// E_BYTE_ORDER not defined, use endianness auto-detection
...
#  define E_PROCESSOR_RISCV
#  if __riscv_xlen == 64
#    define E_PROCESSOR_RISCV_64
#  else
#    define E_PROCESSOR_RISCV_32
#  endif
#  define E_BYTE_ORDER E_LITTLE_ENDIAN
...
#  define E_PROCESSOR_S390
#  if defined(__s390x__)
#    define E_PROCESSOR_S390_X
#  endif
#  define E_BYTE_ORDER E_BIG_ENDIAN
...
*/
// #elif defined(__sh__)
// #  define E_PROCESSOR_SH
// #  if defined(__sh4a__)
// #    define E_PROCESSOR_SH_4A
// #  endif
// E_BYTE_ORDER not defined, use endianness auto-detection
...
#  define E_PROCESSOR_SPARC
#  if defined(__sparc_v9__) || defined(__sparcv9)
#    define E_PROCESSOR_SPARC_V9
#  endif
#  if defined(__sparc64__)
#    define E_PROCESSOR_SPARC_64
#  endif
#  define E_BYTE_ORDER E_BIG_ENDIAN

// -- Web Assembly --
#elif defined(__EMSCRIPTEN__)
#  define E_PROCESSOR_WASM
#  define E_BYTE_ORDER E_LITTLE_ENDIAN
#  define E_PROCESSOR_WORDSIZE 8
#ifdef E_COMPILER_SUPPORTS_SSE2
#  define E_PROCESSOR_X86 6   // enables SIMD support
# define E_PROCESSOR_X86_64 // wasm64
#  define E_PROCESSOR_WASM_64
#endif
...
#if !defined(E_BYTE_ORDER)
#  if defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == E_BIG_ENDIAN || __BYTE_ORDER__ == E_LITTLE_ENDIAN)
// Reuse __BYTE_ORDER__ as-is, since our E_*_ENDIAN #defines match the preprocessor defaults
#    define E_BYTE_ORDER __BYTE_ORDER__
...
/*
   ...
   * If E_PROCESSOR_WORDSIZE was defined above, it's assumed to match the pointer
     size.
   Otherwise, we assume to be 32-bit and then check in qglobal.cpp that it is right.
*/

#if defined __SIZEOF_POINTER__
#  define E_POINTER_SIZE           __SIZEOF_POINTER__
#elif defined(__LP64__) || defined(_LP64)
#  define E_POINTER_SIZE           8
#elif defined(E_PROCESSOR_WORDSIZE)
#  define E_POINTER_SIZE           E_PROCESSOR_WORDSIZE
#else
#  define E_POINTER_SIZE           4
#endif

/*
   Define E_PROCESSOR_WORDSIZE to be the size of the machine's word (usually,
   ...
   Falls back to E_POINTER_SIZE if not set explicitly for the platform.
*/
#ifndef E_PROCESSOR_WORDSIZE
#  define E_PROCESSOR_WORDSIZE        E_POINTER_SIZE
#endif


#endif // UTILS_PROCESSORDETECTION_H_
